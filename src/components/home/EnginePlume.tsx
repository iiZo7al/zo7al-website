...
export default function EnginePlume({ paused }: { paused: boolean }) {
  ...
  // Measured nozzle center in the normalized, axis-corrected Rocket.glb frame.
  // Both plume and hull share bodyRef, so rolling cannot separate the exhaust.
  return <group position={[-0.008, -0.915, 0.032]}>
    ...
    <mesh position={[0, -0.025, 0]} scale={[1, 1.8, 1]}><sphereGeometry args={[0.085, 12, 8]} /><meshBasicMaterial color="#fff0d0" toneMapped={false} transparent opacity={0.9} /></mesh>
